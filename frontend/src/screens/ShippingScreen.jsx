...
const ShippingScreen = () => {
  // ShippingAddress is a empty object by default within the cartSlice file
  // We dispatch the saveShippingAddress so we can update it in the state and localStorage
